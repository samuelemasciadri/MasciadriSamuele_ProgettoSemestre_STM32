...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PCF8575_INT_Pin TMP126_SIO_Pin */
  GPIO_InitStruct.Pin = PCF8575_INT_Pin|TMP126_SIO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : TMP126_CS_Pin TMP126_SCK_Pin */
  GPIO_InitStruct.Pin = TMP126_CS_Pin|TMP126_SCK_Pin;
